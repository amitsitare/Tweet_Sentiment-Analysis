...
def predict():
    if request.method == 'POST':
        ...
        processed_text, positive_count, negative_count = preprocess_text(text)
        ...
        ''', (name, text, cleaned_text, total_words, total_sentences, positive_count, negative_count, sentiment))
        conn.commit()
        ...
        return render_template('result.html', name=name,text=text, cleaned_text=cleaned_text, sentiment=sentiment,
